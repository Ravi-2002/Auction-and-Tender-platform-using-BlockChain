from brownie import Market, StoreFactory, AuctionMarket,TenderMarket, Administration, network
...
def deploy():
    ...
    tender_market = TenderMarket.deploy(administration.address, {"from": admin})
    ...
    set_tx.wait(1)
    set_tx = administration.setTenderMarketContractAddress(tender_market.address, {"from": admin})
    set_tx.wait(1)
