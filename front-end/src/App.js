...
import { Home, MarketPage, AuctionMarketPage, CreateAuction, AuctionPage,TenderMarketPage, CreateTender, TenderPage, MyProductsPage, ProductPage, AddProduct, AddStoreProduct, AllStores, MyStore, StoreProductPage, OrderPage, StorePage } from './pages'
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/tender-market" element={<TenderMarketPage />} />
